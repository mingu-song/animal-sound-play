...
public class AnimalAdapter extends RecyclerView.Adapter<AnimalAdapter.AnimalViewHolder> {
    ...
    public AnimalAdapter(List<Animal> items, Context context, OnItemClickListener listener) {
    ...
    class AnimalViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(final Animal animal, final OnItemClickListener listener) {
